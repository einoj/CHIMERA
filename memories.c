...
const struct Memory mem_arr[12] = {
 {0b00000001, 0b00010000,   128, 256, &PORTA, &PORTC},
 {0b00000010, 0b00000100,   128, 256, &PORTA, &PORTC},
 {0b00000100, 0b00001000,   128, 256, &PORTA, &PORTC},
 {0b00001000, 0b00000010, 8, 4, &PORTA, &PORTC},
 {0b00010000, 0b00000001, 8, 4, &PORTA, &PORTC},
 {0b00100000, 0b00000010, 8, 4, &PORTA, &PORTG},
 ...
 {0b00100000, 0b10000000, 8, 4, &PORTC, &PORTB},
};
